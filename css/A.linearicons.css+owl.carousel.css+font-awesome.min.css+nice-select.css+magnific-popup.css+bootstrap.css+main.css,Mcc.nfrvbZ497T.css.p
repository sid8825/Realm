...
.col-sm-6, .col-md-3, .col-md-4, .col-md-6, .col-md-8, .col-md-9, .col-md-12, .col-lg-3, .col-lg-4, .col-lg-5, .col-lg-6, .col-lg-8, .col-lg-10, .col-lg-12 {
    position: relative;
    width: 100%;
    min-height: 1px;
    padding-right: 15px;
...
.banner-area {
    background: url(../img/xheader-bg.jpg.pagespeed.ic.VkWO8tWd6E.jpg) right;
...
.single-dish h4, .single-dish img {
    -webkit-transition: all .3s ease 0s;
    -moz-transition: all .3s ease 0s;
    -o-transition: all .3s ease 0s;
    transition: all .3s ease 0s;
...
@media (max-width:800px) {
    ...
    background: url(https://preview.colorlib.com/theme/restaurant/img/xvideo-bg.jpg.pagespeed.ic.7PIQvxGV0A.jpg) center;
    background-size: cover;
    padding: 200px 0;
    text-align: center;
}
...
.related-area .primary-btn:hover {
    border: 1px solid #f42f2c;
    background-color: transparent;
    color: #f42f2c;
}
...
.team-area .thumb div {
    ...
    top: 0;
    left: 0;
    background-color: rgba(244, 47, 44, .8);
    color: #fff;
    opacity: 0;
...
.common-input {
    border: 1px solid rgba(111, 117, 152, .3);
    line-height: 48px;
    width: 100%;
    display: block;
    background: transparent;
